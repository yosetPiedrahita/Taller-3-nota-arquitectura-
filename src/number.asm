...
.data
		...
		WelcomeNoticeText1 byte  "|               Bienvenidos               |",0
		WelcomeNoticeText2 byte  "|            Number Crush Game            |",0
		WelcomeNoticeText3 byte  "|    Gabriel Castro   Yosset Piedrahita   |",0
		WelcomeNoticeText4 byte  "|        1151794           1152390        |",0

		PlayerInfoLines byte "+=====================================+",0
		PlayerInfoText byte  "|     Informacion del jugador         |",0
		...
		Level byte 1
		NAMESTRING byte "Digite el nombre del jugador   :  ",0
		...
		NameTag    byte "Nombre  : ",0
		Level1Tag  byte "Nivel        : ",0
		ScoreTag   byte "Puntaje       : ",0
		MovesTag   byte "Movimientos        : ",0

		WrongInputMsg byte "-->  Mala Posicion!  Intentalo de nuevo!",0
		Input1     byte "Digite Primer indice          :   ",0
		Input2     byte "Digite Segundo indice        :   ",0
		
		DuplicationCountCheck dword ?
		Num1 dword ?
		Num2 dword ?

		NoComboReSwap byte 	"--> devolviendo movimiento, Movimiento no posible",0
		NotPossible byte 	"--> Movimiento no posible",0
		Crushing byte 	"--> Combinando",0
		Explosion byte "-->	Explotando",0
		...
		Level1FileHandling		  byte "Nivel-1     :  ",0
		Level2FileHandling		  byte "Nivel-2     :  ",0
		Level3FileHandling		  byte "Nivel-3     :  ",0
		HighestScoreFileHandling  byte "Mejor puntaje  :  ",0
		Level1Score dword   ?
		Level2Score dword   ?
		Level3Score dword   ?
